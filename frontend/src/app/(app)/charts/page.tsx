            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  <Zap
                    className={`h-3 w-3 ${
                      wsConnected ? "text-green-400" : binanceConnected ? "text-green-400" : "text-yellow-400"
                    }`}
                  />
                  <span className="text-[10px] text-muted-foreground">
                    {wsConnected ? "WS Live" : binanceConnected ? "REST" : "Synthetic"}
                  </span>
                </div>
              </div>
            </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="rounded-lg bg-background/50 p-3 text-center">
                  <div className="text-[10px] text-muted-foreground mb-1">Direction</div>
                  <Badge
                    className={
                      signal.direction === "LONG"
                        ? "bg-green-500/20 text-green-400 border-green-500/30"
                ...
                <div className="rounded-lg bg-background/50 p-3 text-center">
                  ...
                  <div className="text-sm font-mono text-white">
                    ${signal.entry.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </div>
                </div>
                <div className="rounded-lg bg-background/50 p-3 text-center">
                ...
                <div className="rounded-lg bg-background/50 p-3 text-center">
                  ...
                  <div className={`text-sm font-mono ${
                    signal.confidence > 0.7 ? "text-green-400" : signal.confidence > 0.4 ? "text-yellow-400" : "text-red-400"
                  }`}>
